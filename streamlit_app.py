...
fruit_choise2 = streamlit.text_input('What Fruit would you like add?')
streamlit.write('The user entered', fruit_choise2)
my_cur.execute("INSERT INTO FRUIT_LOAD_LIST VALUES(fruit_choise2)")
